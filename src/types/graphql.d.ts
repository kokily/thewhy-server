...
export interface Mutation {
  ...
  RemoveAdminQuestion: RemoveAdminQuestionResponse;
...
export interface RemoveAdminQuestionMutationArgs {
  id: string;
}
...
export interface RemoveAdminQuestionResponse {
  ok: boolean;
  error: string | null;
}
